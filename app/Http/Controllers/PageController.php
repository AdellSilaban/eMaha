...
public function save(Request $request)
{
 ...
 return redirect('student')->with('flash', 'YEY BERHASIL')->with('flash_type', 'success');
}
...
return redirect('student')->with('flash', 'Yeay data berhasil di ubah')->with('flash_type', 'primary');
}
...
public function delete($id){
    ...
    return redirect('student')->with('flash', 'Yeay berhasil di hapus')->with('flash_type', 'danger');
}
